...
namespace CTC.CvsntGitImporter.TestCode
{
	...
	public class RevisionTest
	{
		...
		[TestMethod]
		public void CompareTo_Trunk_Equal()
		{
			var r1 = Revision.Create("1.3");
			var r2 = Revision.Create("1.3");

			Assert.AreEqual(r1.CompareTo(r2), 0);
			Assert.AreEqual(r2.CompareTo(r1), 0);
		}

		[TestMethod]
		public void CompareTo_Trunk_NotEqual()
		{
			var r1 = Revision.Create("1.2");
			var r2 = Revision.Create("1.4");
		...
		[TestMethod]
		public void CompareTo_BranchpointAndBranchRevision()
		{
			var r1 = Revision.Create("1.2");
			var r2 = Revision.Create("1.2.4.3");
		...
		[TestMethod]
		public void CompareTo_ParallelBranches()
		{
			var r1 = Revision.Create("1.2.2.1");
			var r2 = Revision.Create("1.2.4.3");
		...
		[TestMethod]
		public void CompareTo_Empty_Empty()
		{
			Assert.AreEqual(Revision.Empty.CompareTo(Revision.Empty), 0);
		}

		[TestMethod]
		public void CompareTo_Empty_NonEmpty()
		{
			var r1 = Revision.Create("1.2.2.1");

			Assert.IsTrue(r1.CompareTo(Revision.Empty) > 0);
			Assert.IsTrue(Revision.Empty.CompareTo(r1) < 0);
		}
