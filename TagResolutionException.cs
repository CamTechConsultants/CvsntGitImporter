...
namespace CTC.CvsntGitImporter
{
	...
	class TagResolutionException : Exception
	{
		...
		/// <summary>
		/// Initializes a new instance of the <cref>TagResolutionException</cref> class with serialized data.
		/// </summary>
		/// <param name="info">The SerializationInfo that holds the serialized object data about the exception being thrown.</param>
		/// <param name="context">The StreamingContext that contains contextual information about the source or destination.</param>
		protected TagResolutionException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
